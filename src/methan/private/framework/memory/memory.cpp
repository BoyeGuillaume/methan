  ...
  m_allocator(nullptr)
{
    ...
    METHAN_LOG_DEBUG(context->logger, "AbstractMemory::AbstractMemory(\"{}\", {}) registered", m_name, m_descriptor.uuid);
    context->memories.push_back(this);
}

METHAN_API Methan::AbstractMemory::~AbstractMemory()
{
    METHAN_LOG_DEBUG(context()->logger, "AbstractMemory::AbstractMemory(\"{}\", {}) destroyed", m_name, m_descriptor.uuid);
